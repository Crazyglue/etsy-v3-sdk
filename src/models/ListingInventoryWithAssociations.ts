 ...
 * @export
 * @interface ListingInventoryWithAssociations
 */
export interface ListingInventoryWithAssociations {
     ...
     * @memberof ListingInventoryWithAssociations
     */
...
/**
 * Check if a given object implements the ListingInventoryWithAssociations interface.
 */
export function instanceOfListingInventoryWithAssociations(value: object): value is ListingInventoryWithAssociations {
    return true;
}

export function ListingInventoryWithAssociationsFromJSON(json: any): ListingInventoryWithAssociations {
    return ListingInventoryWithAssociationsFromJSONTyped(json, false);
}

export function ListingInventoryWithAssociationsFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListingInventoryWithAssociations {
    if (json == null) {
        return json;
    }
    return {
        ...
        'listing': json['listing'] == null ? undefined : ShopListingFromJSON(json['listing']),
    };
}

export function ListingInventoryWithAssociationsToJSON(json: any): ListingInventoryWithAssociations {
    return ListingInventoryWithAssociationsToJSONTyped(json, false);
}

export function ListingInventoryWithAssociationsToJSONTyped(value?: ListingInventoryWithAssociations | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'listing': ShopListingToJSON(value['listing']),
    };
}
